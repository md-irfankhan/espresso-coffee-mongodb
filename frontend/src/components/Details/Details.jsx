...
const Details = () => {
    return (
        ...
        <div className='max-w-[1200px] mx-auto'>
            <h1 className='py-14'><Link className='flex items-center'><FaLongArrowAltLeft className='w-10'></FaLongArrowAltLeft> <span className='font-rancho text-shadow-lg text-[20px]'>Back to home</span></Link></h1>
