...
const ProductPage = () => {
    ...
    return (
        <div className='relative mt-4'>
            <img className='absolute top-0 left-0 lg:-left-40 -z-10' src={bg4} alt="" />
            <img className='absolute bottom-0 lg:-right-40 right-0 -z-10' src={bg5} alt="" />
            <div className="text-center">
                ...
                <button className="bg-[#E3B577]  text-[18px] font-rancho py-1 px-1.5 rounded text-white text-shadow-black text-shadow-md border-2 border-black"><Link to={'/add'} className='flex items-center gap-1'>Add Coffee <RiCupLine className='text-black'></RiCupLine></Link> </button>
            </div>
